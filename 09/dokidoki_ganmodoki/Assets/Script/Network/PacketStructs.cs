...
public struct CharEquipment
{
	...
	// 装備情報はアイテムIDを送信せずにタイプを送信するだけで済む
	// ような仕様に変更されました.
	// このため文字列のアイテムIDではなく, アイテムタイプのint型
	// で通信をすることになりました.
	public int			shotType;	// 選択した武器情報.
}
...
{
	public string		lairId;			//  ジェネレータ名.
	public string 		monsterId;		// モンスター名.
...
{
	public string		bossId;		// ボスのID.
	
	public const int 	bossNameLength = 64;	// ボスIDの長さ.
}
