// TCPで送受信するセッション管理を行うクラス定義
//
// ■プログラムの説明
// TCPで送受信するセッションの管理を行うクラスです.
// Session クラスで override するメソッドの定義をしています.
// このクラス、ノードが通信を行う TransportTCP クラスをトランスポート(m_transports)として管理しています.
//
